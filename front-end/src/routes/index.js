...
import ProductTable from 'src/pages/dashboard/ProductTable';
  ...
  return useRoutes([
    ...
    // Dashboard Routes
    {
      ...
      children: [
        ...
        { path: 'orders', element: <UserCarts /> },
        { path: 'ecommerce', element: <GeneralEcommerce /> },
        { path: 'banking', element: <GeneralBanking /> },
        { path: 'booking', element: <GeneralBooking /> },
        { path: 'products-page', element: <ProductTable /> },
...
const UserCarts = Loadable(lazy(() => import('../pages/dashboard/UserCarts')));
